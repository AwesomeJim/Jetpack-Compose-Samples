...
class BlurViewModel(private val bluromaticRepository: BluromaticRepository) : ViewModel() {
    ...
    val blurUiState: StateFlow<BlurUiState> =
        bluromaticRepository.outputWorkInfo.map { info ->
            ...
            //The flow converts from a cold Flow to a hot StateFlow by calling the stateIn() function.
        }.stateIn(
            scope = viewModelScope,
            started = SharingStarted.WhileSubscribed(5_000), //This parameter controls when sharing starts and stops.
