...
include(":DessertRelease-DataStore")
include(":BlurOMatic-WorkManager")
include(":B-WaterMe-WorkManager")
include(":JuiceTrackerViews")
include(":JuiceTracker-Compose-View")
include(":AdvancedStateAndSideEffectsCodelab")
include(":PagingPokemonGrapgQL")
include(":ApolloGraphQL")
include(":PagingBasicsGoogle")
include(":PaggingAdvancedCodeLab")
include(":PagingNewsApp")
include(":PagingPopularMovies")
include(":AccessibilityCodelab")
include(":CookBookSampleLogin")
