 ...
 */
class AmphibiansViewModel(private val amphibiansRepository: MarsPhotosRepository) : ViewModel() {
    ...
    companion object {
        val Factory: ViewModelProvider.Factory = viewModelFactory {
            initializer {
                ...
                val amphibiansRepository = application.container.marsPhotosRepository
