...
fun HomeScreen(
    ...
    when (marsUiState) {
        ...
        is MarsUiState.Success ->PhotosGridScreen(marsUiState.photos, modifier) // MarsPhotoCard(photo = marsUiState.photos, modifier = modifier) //ResultScreen(marsUiState.photos, modifier)
