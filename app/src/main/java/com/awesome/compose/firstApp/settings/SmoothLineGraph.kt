...
//        for (pair in zipList) {
//
//            val fromValuePercentage =
//                getValuePercentageForRange(pair.first.temperatureFloat, max, min)
//            val toValuePercentage =
//                getValuePercentageForRange(pair.second.temperatureFloat, max, min)
//
//            Canvas(
//                modifier = Modifier
//                    .fillMaxHeight()
