...
//        )
    ...
    val items: Flow<PagingData<Article>> = Pager(
        ...
        .cachedIn(viewModelScope) // to maintain paging state through configuration or navigation changes, we use the cachedIn() method passing it the androidx.lifecycle.viewModelScope.
